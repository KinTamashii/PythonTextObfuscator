...
# ---------------------- 0 == Length; Text is split by length. This is faster as less requests are made. ------------------ #
# --- 1 == Newline; Text is split by newlinesh. This is slower as more requests are made, but allows for more variety. ---- #
# ------------------------------------------------------------------------------------------------------------------------- #
